...
type LegsScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Legs'>;

const Legs = () => {
  const navigation = useNavigation<LegsScreenNavigationProp>();
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        >
          ...
          <>
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Категория Ноги</Text>
              <View style={styles.videosGrid}>
