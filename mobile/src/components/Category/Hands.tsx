...
type HandsScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Hands'>;

const Hands = () => {
  const navigation = useNavigation<HandsScreenNavigationProp>();
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        >
          ...
          <>
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Категория Руки</Text>
              <View style={styles.videosGrid}>
